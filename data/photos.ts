...
export const technext24Photos: PhotoItem[] = Array.from({ length: 25 }, (_, i) => {
  ...
  return {
    id: `technext24-${num}`,
    src: `/images/technext24/technext_${num}.jpeg`,
...
export const bolt20Photos: PhotoItem[] = Array.from({ length: 24 }, (_, i) => {
  ...
  return {
    id: `bolt20-${num}`,
    src: `/images/bolt20/bolt_${num}.jpeg`,
...
export const icetite20DrivePhotos: PhotoItem[] = Array.from({ length: 39 }, (_, i) => {
  ...
  return {
    id: `icetite20-${num}`,
    src: `/images/icetite20_drive/icetite20_${num}.jpg`,
...
export const icetite24Photos: PhotoItem[] = [
  ...
  {
    id: "icetite24-02",
    src: "/images/gallery/icetite24_dignitaries.jpg",
  ...
  {
    id: "icetite24-03",
    src: "/images/gallery/icetite24_keynote.jpg",
  ...
  {
    id: "icetite24-08",
    src: "/images/ic-etite24-preview.jpg",
